...
夜間 Gold 昇格（update-gold）は、リポ内差分に加えて**外部ソース（GitHub Issues/Discussions）**からも決定・用語を抽出できます。開発リポの Issues/Discussions で仕様や決定を議論している案件で使います。
